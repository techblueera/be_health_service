      ...
      schemas: {
        Category: {
          ...
          properties: {
            ...
            name: { type: 'string' },
            key: { type: 'string', description: 'Unique, human-readable identifier' },
            description: { type: 'string' },
            parentId: { type: 'string', nullable: true, description: 'ID of the parent category' },
            level: {type: 'number', description: 'Hierarchy level of the category'},
        ...
        Inventory: {
          ...
          properties: {
            ...
            businessId: { type: 'string', description: 'Business ID' },
            productVariant: { type: 'string', description: 'Product Variant ID' },
            pincode: { type: 'string' },
            cityName: { type: 'string' },
            batches: {
              type: 'array',
        ...
        Services: {
          ...
          properties: {
            ...
            serviceType: { type: 'string', enum: ['LAB_TEST', 'LAB_PACKAGE', 'PROCEDURE', 'CONSULTATION'] },
            name: { type: 'string' },
            description: { type: 'string' },
            labDetails: {
              type: 'object',
