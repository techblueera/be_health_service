...
import { createBusinessInventory, getBusinessProducts, updateInventory, deleteInventory } from '../../controllers/pharmacyControllers/inventory.controller.js';
 ...
 */
router.get('/my-products', protect, authorizeRoles('BUSINESS'), getBusinessProducts);
