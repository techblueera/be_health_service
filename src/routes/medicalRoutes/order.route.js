...
import { createOrder, updateOrder, checkOrderStatus, findOrderAlternatives, getUserOrders } from '../../controllers/medicalStore/order.controller.js';
...
/**
 * @swagger
 * /api/orders/{orderId}/alternatives:
 *   get:
